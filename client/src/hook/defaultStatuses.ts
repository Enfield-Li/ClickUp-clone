...
export const custom: StatusColumns = [
  ...
  { id: 2, title: "DONE", color: "green.400", orderIndex: 2, listId: 1 },
];

export const kanban: StatusColumns = [
  { id: 1, title: "OPEN", color: "blue.300", orderIndex: 1, listId: 1 },
  { id: 2, title: "IN_PROGRESS", color: "purple.400", orderIndex: 2, listId: 1 },
  { id: 3, title: "REVIEW", color: "purple.400", orderIndex: 3, listId: 1 },
  { id: 4, title: "CLOSED", color: "green.400", orderIndex: 4, listId: 1 },
];
...
export const marketing: StatusColumns = [
  ...
  { id: 6, title: "CLOSED", color: "green.400", orderIndex: 6, listId: 1 },
];
...
export const scrum: StatusColumns = [
  ...
  { id: 9, title: "CLOSED", color: "green.400", orderIndex: 9, listId: 1 },
];
