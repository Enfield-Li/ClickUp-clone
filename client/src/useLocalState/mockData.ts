...
export const mockTaskList: TaskList = [
  {
    ...
    dueDate: { name: DueDateRange.TODAY, orderIndex: 1 },
    priority: { name: Priority.HIGH, orderIndex: 3, columnId: 3 },
  },
  {
    id: 222,
    title: "22222",
    ...
    dueDate: { name: DueDateRange.TODAY, orderIndex: 3 },
    priority: { name: Priority.HIGH, orderIndex: 2, columnId: 3 },
  },
  {
    id: 333,
    title: "33333",
    ...
    dueDate: { name: DueDateRange.TODAY, orderIndex: 2 },
    priority: { name: Priority.HIGH, orderIndex: 1, columnId: 3 },
  },
];
